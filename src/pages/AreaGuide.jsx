  ...
  return (
    <>
      ...
      <div className="section-pad" style={{ padding: '80px 40px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="why-grid-2col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          {area.whyCards.map(c => (
      ...
      <div style={{ background: 'var(--warm-cream-dark)' }}>
        <div className="section-pad" style={{ padding: '80px 40px', maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="stats-grid-4col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20, marginTop: 32 }}>
            {area.stats.map(st => (
      ...
      <div className="section-pad" style={{ padding: '80px 40px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 32 }}>
          {area.schools.map(sc => (
            <div key={sc.name} style={{ background: 'white', borderRadius: 14, padding: '20px 24px', display: 'flex', alignItems: 'center', gap: 20, boxShadow: '0 1px 8px rgba(0,0,0,0.04)', flexWrap: 'wrap' }}>
      ...
      <div style={{ background: 'var(--warm-cream-dark)' }}>
        <div className="section-pad" style={{ padding: '80px 40px', maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="lifestyle-grid-2col" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 20, marginTop: 32 }}>
      ...
      <div className="section-pad" style={{ padding: '80px 40px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="commute-grid-2col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 32 }}>
          {area.commutes.map(c => (
      ...
      <div className="section-pad" style={{ background: 'var(--olive-dark)', padding: '60px 40px', textAlign: 'center' }}>
        ...
        <a href="tel:5402394636" style={{ display: 'inline-flex', padding: '16px 32px', background: 'var(--terracotta)', color: 'white', borderRadius: 10, fontSize: 16, fontWeight: 500 }}>Get in touch →</a>
      </div>

      <div className="section-pad" style={{ padding: '60px 40px', maxWidth: 1200, margin: '0 auto' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 24, marginBottom: 24 }}>Explore other areas</h3>
        <div className="other-areas-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
          {area.otherAreas.map(oa => (
            <Link to={`/areas/${oa.slug}`} key={oa.slug} style={{ background: 'white', borderRadius: 12, padding: 20, boxShadow: '0 1px 8px rgba(0,0,0,0.04)', border: '1.5px solid transparent' }}>
