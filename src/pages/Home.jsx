...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="section-pad" style={{ padding: '80px 40px', textAlign: 'center' }} id="contact">
      ...
      <section className="hero-section section-pad" style={{ display: 'flex', alignItems: 'center', padding: '80px 40px', position: 'relative', overflow: 'hidden' }}>
        <div className="hero-grid" style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: 80, alignItems: 'center', width: '100%' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(36px, 4.5vw, 52px)', lineHeight: 1.1, color: 'var(--charcoal)', marginBottom: 24, letterSpacing: '-0.02em' }}>
